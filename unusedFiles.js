...
define(function (require, exports, module) {
    ...
    function compareFiles(callingFilesList, unusedFilesList) {
        ...
        function checkinginFile(n) {
            DocumentManager.getDocumentForPath(callingFilesList[n].fullPath).done(function (doc) {
                var unusedFilesListLength   = unusedFilesList.length;
                for (var i = 0; i < unusedFilesListLength; i++) {
                    if ((typeof unusedFilesList[i] !== "undefined")) var used = new RegExp(unusedFilesList[i]["name"], 'i').test(doc.getText());
    ...
    function listFiles() {
        FileIndexManager.getFileInfoList("all").done( function (fileListResult) {
            ...
            var ext_a                 = [".html", ".htm", ".css", ".php", ".js", ".aspx", ".ascx", ".cshtml", ".less", ".scss", ".sass", ".json", ".md"],
